...
class AktivitetServiceTest : IntegrationTest() {
    ...
    fun `skal cachea svaret fra client`() {
        ...
        aktivitetService.hentAktiviteter("1", Skjematype.SØKNAD_BARNETILSYN)
        val aktivitetIdent1 = aktivitetService.hentAktiviteter("1", Skjematype.SØKNAD_BARNETILSYN)
        aktivitetService.hentAktiviteter("2", Skjematype.SØKNAD_BARNETILSYN)
        val aktivitetIdent2 = aktivitetService.hentAktiviteter("2", Skjematype.SØKNAD_BARNETILSYN)
    ...
    fun `skal ikke returnere typer som ikke gir rett på stønaden`() {
        ...
        val aktiviteter = aktivitetService.hentAktiviteter("1", Skjematype.SØKNAD_BARNETILSYN)
